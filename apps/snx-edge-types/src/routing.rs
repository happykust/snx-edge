//! Routing / RouterOS wire-format types.
...
/// Payload accepted by `POST /routing/clients` and `POST /routing/bypass`.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct AddressListEntryCreate {
    pub address: String,
    #[serde(default)]
    pub comment: Option<String>,
    #[serde(default)]
...
/// Diagnostics result returned by `GET /routing/diagnostics`.
#[derive(Debug, Clone, Serialize, Deserialize)]
